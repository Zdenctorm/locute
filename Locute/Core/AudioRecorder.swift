...
actor AudioRecorder {
    ...
    private let logger = Logger(subsystem: "com.example.locute", category: "audio")
    ...
    func startRecording() throws {
        ...
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("locute-\(UUID().uuidString)")
...
private final class AudioCaptureController: NSObject, AVCaptureAudioDataOutputSampleBufferDelegate, @unchecked Sendable {
    ...
    private let captureQueue = DispatchQueue(label: "com.example.locute.capture", qos: .userInteractive)
...
private final class RecordingSession: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.example.locute.audio-writer")
