...
extension Notification.Name {
    static let locuteHotkeyPreferenceChanged = Notification.Name("LocuteHotkeyPreferenceChanged")
}
...
enum HotkeyPreference {
    ...
    static var current: HotkeyChoice {
        ...
        set {
            ...
            NotificationCenter.default.post(name: .locuteHotkeyPreferenceChanged, object: nil)
        }
    }
}
...
final class HotkeyManager {
    ...
    private let logger = Logger(subsystem: "com.example.locute", category: "hotkey")
