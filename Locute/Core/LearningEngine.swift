...
extension Notification.Name {
    /// Nahrazuje starší notifikaci slovníku. Posílá `LearningEngine` po každém commitu.
    static let locuteLearnedTermsChanged = Notification.Name("LocuteLearnedTermsChanged")
}
...
final class LearningEngine {
    ...
    func reloadFromDisk() {
        _ = loadFromDisk()
        NotificationCenter.default.post(name: .locuteLearnedTermsChanged, object: nil)
    }
    ...
    private func postLearnedToast(canonical: String) {
        ...
        NotificationCenter.default.post(
            name: .locuteLearnedTermsChanged,
            object: nil,
