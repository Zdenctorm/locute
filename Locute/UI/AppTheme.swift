...
enum AppTheme {
    ...
    enum Color {
        ...
        static let surface: NSColor = {
            NSColor(name: "LocuteSurface", dynamicProvider: { appearance in
        ...
        static let panel: NSColor = {
            NSColor(name: "LocutePanel", dynamicProvider: { appearance in
                let isDark = appearance.bestMatch(from: [.aqua, .darkAqua]) == .darkAqua
                return isDark
        ...
        static let separator: NSColor = {
            NSColor(name: "LocuteSeparator", dynamicProvider: { appearance in
                let isDark = appearance.bestMatch(from: [.aqua, .darkAqua]) == .darkAqua
                return isDark
