...
```mermaid
quadrantChart
    title Brand positioning (abstraktní osy)
    x-axis Cloud-first --> Local-first
    y-axis Playful / SaaS --> Quiet / Editorial
    quadrant-1 Quiet Local
    quadrant-2 Quiet Cloud
    quadrant-3 Loud Cloud
    quadrant-4 Loud Local
    Wispr Flow: [0.15, 0.25]
    Aqua Voice: [0.35, 0.30]
    Superwhisper: [0.55, 0.20]
    VocaMac: [0.88, 0.45]
    MetaWhisp: [0.90, 0.50]
    Locute: [0.92, 0.78]
    Quietype: [0.85, 0.92]
